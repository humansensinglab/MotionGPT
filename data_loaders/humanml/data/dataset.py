...
class Text2MotionDatasetV2(data.Dataset):
    def __init__(self, opt, mean, std, split_file, w_vectorizer):
        ...
        for name in tqdm(id_list):
            try:
                ...
                text_data = []
                flag = False
                with cs.open(pjoin(opt.babel_text_dir, name + '.txt')) as b_f:
                    babel_text = b_f.readline()
                    try:
                        with cs.open(pjoin(opt.gpt_text_dir, name + '.txt')) as g_f:
                            gpt_text = g_f.readline()
                            ...
                            with cs.open(pjoin(opt.text_dir, name + '.txt')) as f:
                                for line in f.readlines():
                                    ...
                                    text_dict['caption'] = caption
                                    text_dict['tokens'] = tokens
                                    text_dict['babel_text'] = babel_text
                                    text_dict['gpt_text'] = gpt_text
                                    if f_tag == 0.0 and to_tag == 0.0:
                                        flag = True
                                        text_data.append(text_dict)
                                    else:
    ...
    def __getitem__(self, item):
        ...
        # Randomly select a caption
        text_data = random.choice(text_list)
        if text_data['gpt_text'] != 'None' and text_data['babel_text'] != 'None':
            caption, tokens, babel_text = text_data['caption'], text_data['tokens'], random.choice((text_data['babel_text'], text_data['gpt_text']))
        elif text_data['gpt_text'] != 'None':
            caption, tokens, babel_text = text_data['caption'], text_data['tokens'], text_data['gpt_text']
        else: #text_data['gpt_text'] is 'None'
            caption, tokens, babel_text = text_data['caption'], text_data['tokens'], random.choice((text_data['caption'], text_data['gpt_text']))
        ...
        # print(tokens)
        return word_embeddings, pos_one_hots, caption, sent_len, motion, m_length, '_'.join(tokens), babel_text
...
class TextOnlyDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        text_data = random.choice(text_list)
        # if text_data['gpt_text'] != 'None' and text_data['babel_text'] != 'None':
        #     caption, tokens, babel_text = text_data['caption'], text_data['tokens'], random.choice((text_data['babel_text'], text_data['gpt_text'], text_data['caption']))
        # elif text_data['gpt_text'] != 'None' and text_data['babel_text'] ==  'None':
        #     caption, tokens, babel_text = text_data['caption'], text_data['tokens'], random.choice((text_data['babel_text'], text_data['caption']))
        # else: #text_data['gpt_text'] is 'None'
        #     caption, tokens, babel_text = text_data['caption'], text_data['tokens'], text_data['caption']
        if text_data['gpt_text'] != 'None' and text_data['babel_text'] != 'None':
            caption, tokens, babel_text = text_data['caption'], text_data['tokens'], random.choice((text_data['babel_text'], text_data['gpt_text']))
        elif text_data['gpt_text'] != 'None':
            caption, tokens, babel_text = text_data['caption'], text_data['tokens'], text_data['gpt_text']
        ...
        # caption, tokens, babel_text = text_data['caption'], text_data['tokens'], text_data['babel_text']
        return None, None, caption, None, np.array([0]), self.fixed_length, None, babel_text
...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='./dataset/humanml_opt.txt', split="train", **kwargs):
        ...
        opt.babel_text_dir = pjoin(abs_base_path, opt.babel_text_dir)
        opt.gpt_text_dir = pjoin(abs_base_path, opt.gpt_text_dir)
