...
def add_model_options(parser):
    ...
    group.add_argument("--second_llm", default='clip',
                       choices=['clip', 'distilbert', 't5', 'st5', 'mini', 'distbert'], type=str,
                       help="Architecture types of the second LLM for the low level.")
...
def add_generate_options(parser):
    ...
    group.add_argument("--input_babel_text", default='', type=str,
                       help="Path to a text file lists text prompts to be synthesized. If empty, will take text prompts from dataset.")
    ...
    group.add_argument("--babel_prompt", default='None', type=str,
                       help="The BABEL text prompt to be generated. If empty, will use 'None'.")
...
def add_edit_options(parser):
    ...
    group.add_argument("--babel_condition", default='None', type=str,
                       help="Editing will be conditioned on this low level text prompt. "
                            "If empty, will perform 'None'.")
